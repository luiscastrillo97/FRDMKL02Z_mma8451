...
void LEDs_InitPins(void)
{
    ...
    PORT_SetPinConfig(LEDS_INITPINS_LED_BLUE_PORT, LEDS_INITPINS_LED_BLUE_PIN, &LED_BLUE);
    ...
    PORT_SetPinConfig(LEDS_INITPINS_LED_RED_PORT, LEDS_INITPINS_LED_RED_PIN, &LED_RED);
