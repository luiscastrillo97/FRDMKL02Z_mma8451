...
- options: {callFromInitBoot: 'true', coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '13', peripheral: GPIOB, signal: 'GPIO, 10', pin_signal: ADC0_SE9/PTB10/TPM0_CH1, direction: OUTPUT, gpio_init_state: 'true', pull_select: up, pull_enable: disable}
  - {pin_num: '2', peripheral: GPIOB, signal: 'GPIO, 7', pin_signal: PTB7/IRQ_3/TPM1_CH0, direction: OUTPUT, gpio_init_state: 'true', pull_select: up, pull_enable: disable}
  - {pin_num: '1', peripheral: GPIOB, signal: 'GPIO, 6', pin_signal: PTB6/IRQ_2/LPTMR0_ALT3/TPM1_CH1/TPM_CLKIN1, direction: OUTPUT, gpio_init_state: 'true', pull_select: up,
    pull_enable: disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_I2CPins
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void BOARD_I2CPins(void)
{
    /* Port B Clock Gate Control: Clock enabled */
    CLOCK_EnableClock(kCLOCK_PortB);

    /* PORTB3 (pin 23) is configured as I2C0_SCL */
    PORT_SetPinMux(BOARD_I2CPINS_ACCEL_SCL_PORT, BOARD_I2CPINS_ACCEL_SCL_PIN, kPORT_MuxAlt2);

    /* PORTB4 (pin 24) is configured as I2C0_SDA */
    PORT_SetPinMux(BOARD_I2CPINS_ACCEL_SDA_PORT, BOARD_I2CPINS_ACCEL_SDA_PIN, kPORT_MuxAlt2);
}
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_mma8451Pins
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void BOARD_mma8451Pins(void)
{
    ...
    GPIO_PinInit(BOARD_MMA8451PINS_ACCEL_IRQ_8_GPIO, BOARD_MMA8451PINS_ACCEL_IRQ_8_PIN, &ACCEL_IRQ_8_config);
    ...
    PORT_SetPinConfig(BOARD_MMA8451PINS_ACCEL_IRQ_8_PORT, BOARD_MMA8451PINS_ACCEL_IRQ_8_PIN, &ACCEL_IRQ_8);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
